# My Neovim Config (With Kickstart.nvim inspiration)

From a bold copy of Kickstart.nvim to a reworked config with plugins like
Codeium.nvim for AI integration, automatic lsp integration and prettier than ever.

Needs some plugin that bridges the gap between mason and none-ls so that it automatically
adds the sources installed in the mason package manager to the none-ls sources.

Some more plugins include:
